...
pandoc CV.md -o CV.pdf --pdf-engine="C:\Program Files\wkhtmltopdf\bin\wkhtmltopdf.exe" -V margin-top=15mm -V margin-bottom=15mm -V margin-left=18mm -V margin-right=18mm -V page-size=A4 --css=cv.css

# Alejandro Tejeda
## Backend Developer | QA Engineer
Phone: (+52) 231-148-8980 | Email: alex2227@hotmail.com | LinkedIn: linkedin.com/in/alejandro-tejeda-moreno-195967268 | Location: Teziutlán, Puebla, Mexico

## Summary
Backend Developer and QA Engineer with hands-on experience building scalable REST APIs using NestJS with experience using Spring Boot. Skilled in automated testing with Playwright, manual testing, and database optimization with PostgreSQL. Experienced working in Agile Scrum environments with cross-functional teams.
...
## Certifications
Microsoft Azure Fundamentals (AZ-900) | Scrum Fundamentals Certified | CCNA: Switching, Routing, and Wireless Essentials
...
- Evaluate AI-generated responses for accuracy, cultural relevance, and instruction adherence
